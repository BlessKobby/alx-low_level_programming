...
/**
 * linear_skip - Looks for a value conatined in a skip list; assumes a
 * list with sorted values and a single skip layer with nodes at every
 * index which is a multiple of the square root of the size of the list.
 *
